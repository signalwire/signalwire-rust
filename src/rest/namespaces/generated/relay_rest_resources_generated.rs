...
impl<'a> Addresses<'a> {
    ...
    pub fn get(
        ...
        self.client().get(&self.path(&[id.as_ref()]), params)
    }
    ...
    pub fn delete(&self, id: &str) -> Result<Value, SignalWireRestError> {
        self.client().delete(&self.path(&[id.as_ref()]))
    }
}
...
impl<'a> Lookup<'a> {
    ...
    pub fn phone_number(
        ...
        self.client()
            .get(&self.path(&["phone_number", e164.as_ref()]), params)
    }
}
...
impl<'a> Mfa<'a> {
    ...
    pub fn verify(
        ...
        self.client().post(
            &self.path(&[request_id.as_ref(), "verify"]),
            &request.build(),
        )
    }
}
...
impl<'a> NumberGroups<'a> {
    ...
    pub fn list_memberships(
        ...
        self.client().get(
            &self.path(&[group_id.as_ref(), "number_group_memberships"]),
            params,
        )
    }
...
impl<'a> Queues<'a> {
    ...
    pub fn list_members(
        ...
        self.client()
            .get(&self.path(&[queue_id.as_ref(), "members"]), params)
    }
    ...
    pub fn get_next_member(
        ...
        self.client()
            .get(&self.path(&[queue_id.as_ref(), "members", "next"]), params)
    }
    ...
    pub fn get_member(
        ...
        self.client().get(
            &self.path(&[queue_id.as_ref(), "members", id.as_ref()]),
            params,
        )
    }
}
...
impl<'a> RegistryBrands<'a> {
    ...
    pub fn create(&self, body: &Value) -> Result<Value, SignalWireRestError> {
        self.client().post(&self.base_path().to_string(), body)
    }
    ...
    pub fn list_campaigns(
        ...
        self.client()
            .get(&self.path(&[id.as_ref(), "campaigns"]), params)
    }
    ...
    pub fn create_campaign(&self, id: &str, body: &Value) -> Result<Value, SignalWireRestError> {
        self.client()
            .post(&self.path(&[id.as_ref(), "campaigns"]), body)
    }
}
...
impl<'a> RegistryCampaigns<'a> {
    ...
    pub fn update(
        ...
        self.client()
            .put(&self.path(&[id.as_ref()]), &request.build())
    }
    ...
    pub fn list_numbers(
        ...
        self.client()
            .get(&self.path(&[id.as_ref(), "numbers"]), params)
    }
    ...
    pub fn list_orders(
        ...
        self.client()
            .get(&self.path(&[id.as_ref(), "orders"]), params)
    }
    ...
    pub fn create_order(
        ...
        self.client()
            .post(&self.path(&[id.as_ref(), "orders"]), &request.build())
    }
}
...
impl<'a> SipProfile<'a> {
    ...
    pub fn update(&self, request: SipProfileUpdateRequest) -> Result<Value, SignalWireRestError> {
        self.client()
            .put(&self.base_path().to_string(), &request.build())
    }
}
...
impl<'a> VerifiedCallers<'a> {
    ...
    pub fn redial_verification(&self, id: &str) -> Result<Value, SignalWireRestError> {
        self.client().post(
            &self.path(&[id.as_ref(), "verification"]),
    ...
    pub fn submit_verification(
        ...
        self.client()
            .put(&self.path(&[id.as_ref(), "verification"]), &request.build())
    }
}
