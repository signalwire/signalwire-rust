...
impl<'a> GenericResources<'a> {
    ...
    pub fn list_addresses(
        ...
        self.client()
            .get(&self.path(&[id.as_ref(), "addresses"]), params)
    }
    ...
    pub fn assign_phone_route(
        ...
        self.client()
            .post(&self.path(&[id.as_ref(), "phone_routes"]), &request.build())
    }
    ...
    pub fn assign_domain_application(
        ...
        self.client().post(
            &self.path(&[id.as_ref(), "domain_applications"]),
            &request.build(),
        )
    }
}
...
///
/// Composes [`FabricResource`] (its base-path is baked in per §4) and adds the
/// resource's declared/set methods.
...
impl<'a> CallFlows<'a> {
    ...
    pub fn list_addresses(
        ...
        self.client().get(
            &format!("/api/fabric/resources/call_flow/{}/addresses", id),
            params,
        )
    }
    ...
    pub fn list_versions(
        ...
        self.client().get(
            &format!("/api/fabric/resources/call_flow/{}/versions", id),
            params,
        )
    }
...
impl<'a> ConferenceRooms<'a> {
    ...
    pub fn list_addresses(
        ...
        self.client().get(
            &format!("/api/fabric/resources/conference_room/{}/addresses", id),
            params,
        )
    }
}
...
impl<'a> Subscribers<'a> {
    ...
    pub fn list_sip_endpoints(
        ...
        self.client().get(
            &self.path(&[subscriber_id.as_ref(), "sip_endpoints"]),
            params,
        )
    }
    ...
    pub fn get_sip_endpoint(
        ...
        self.client().get(
            &self.path(&[subscriber_id.as_ref(), "sip_endpoints", id.as_ref()]),
            params,
        )
    }
    ...
    pub fn delete_sip_endpoint(
        ...
        self.client()
            .delete(&self.path(&[subscriber_id.as_ref(), "sip_endpoints", id.as_ref()]))
    }
}
...
impl<'a> FabricTokens<'a> {
    ...
    pub fn create_subscriber_token(
        ...
        self.client().post(
            &"/api/fabric/subscribers/tokens".to_string(),
            &request.build(),
        )
    }
    ...
    pub fn refresh_subscriber_token(
        ...
        self.client().post(
            &"/api/fabric/subscribers/tokens/refresh".to_string(),
            &request.build(),
        )
    }
    ...
    pub fn create_invite_token(
        ...
        self.client().post(
            &"/api/fabric/subscriber/invites".to_string(),
            &request.build(),
        )
    }
    ...
    pub fn create_guest_token(
        ...
        self.client()
            .post(&"/api/fabric/guests/tokens".to_string(), &request.build())
    }
    ...
    pub fn create_embed_token(
        ...
        self.client()
            .post(&"/api/fabric/embeds/tokens".to_string(), &request.build())
    }
}
