...
#     resource modules + client-tree containers. (``projects`` — the staged
...
#     ``projects`` HAS a servers block, so it is not types-only either and stays
#     out of the canonical set (matching the reference, which stages but does not
#     yet ship it).
#
