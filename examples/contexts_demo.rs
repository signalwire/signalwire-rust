...
fn main() {
    ...
    // Franklin — greeter
    {
        ...
        greeter.set_enter_fillers(serde_json::json!([
            "Hey there! Welcome to TechCo. I'm Franklin!"
        ]));
    ...
    // Rachael — sales
    {
        ...
        sales.set_system_prompt("You are Rachael, a knowledgeable sales specialist.");
        sales.set_enter_fillers(serde_json::json!([
            "Hi! I'm Rachael from sales. Let me help you find the perfect system."
        ]));
    ...
    // Dwight — support
    {
        ...
        support.set_system_prompt("You are Dwight, a no-nonsense technical support specialist.");
        support.set_enter_fillers(serde_json::json!([
            "Dwight here. Let's get your issue sorted out."
        ]));
